...
namespace MyJournal.Domain.Migrations
{
    ...
    [Migration("20190601115244_LastActivityProvided")]
    partial class LastActivityProvided
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyJournal.Domain.Entities.Lesson", b =>
                {
                    ...
                    b.Property<bool>("IsForSemesterMarks");

                    b.Property<bool>("IsForThematicMarks");

                    b.Property<bool>("IsForYearMarks");
            ...
            modelBuilder.Entity("MyJournal.Domain.Entities.TeacherSubjectRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TeacherSubjectRelations");
                });
            ...
            modelBuilder.Entity("MyJournal.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("MyJournal.Domain.Entities.ApplicationUser", "Sender")
                        .WithMany()
